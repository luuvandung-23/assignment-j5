		...
		<div class="row mb-4">
			<div class="col ">
				...
				<table class="table table-stripe con">
					<tr>
						<th><a href="/hoadon?typesort=${typeSort}">Order ID</a></th>
						<th>Date Created</th>
						<th>Address</th>
						<th>Status</th>
						<th></th>
					...
					<c:forEach var="item" items="${dshd.content}">
						<tr class="text-center">
							...
							<td><a class="btn btn-primary"
								href="/hoadon?trang=${page}&typesort=${typesort_page}&id=${item.id}">view</a>
							</td>
						</tr>
					</c:forEach>
				</table>
				...
				<nav aria-label="Page navigation example">
					<ul class="pagination">
						...
						<c:forEach var="item" items="${listtrang}">
							<li class="page-item"><a class="page-link"
								href="/hoadon?trang=${item-1}&typesort=${typesort_page}">${item}</a></li>
						</c:forEach>
						<li class="page-item"><a class="page-link"
							href="/hoadon?trang=<c:choose>
